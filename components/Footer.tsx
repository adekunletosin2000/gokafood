  ...
  return (
    <footer className="relative bg-[#0A0A0A] text-white pt-20 pb-32 px-6 overflow-hidden">
      ...
      <a 
        ...
        className="fixed bottom-24 right-6 z-110 bg-[#25D366] text-white w-14 h-14 rounded-full flex items-center justify-center shadow-[0_10px_40px_rgba(37,211,102,0.4)] hover:scale-110 active:scale-90 transition-all group"
      >
